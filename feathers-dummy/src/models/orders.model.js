...
const mongooseSchema = require('../services/orders/orders.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const orders = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['orders']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('orders', orders);
