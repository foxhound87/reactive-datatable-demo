...
const mongooseSchema = require('../services/profiles/profiles.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const profiles = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['profiles']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('profiles', profiles);
